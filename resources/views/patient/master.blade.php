    ...
    <div class="header">
        <div class="header-left">
            <a href="{{url('/patient')}}" class="logo">
                <img src="/assets/img/logo.png" width="35" height="35" alt=""> <span>EHR</span>
            </a>
        </div>
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="doctors.html"><i class="fa fa-user-md"></i> <span>Find Doctors</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="assets.html"><i class="fa fa-cube"></i> <span>Prescription History</span></a>
                    </li>
                    <li class="submenu">
                        <a href="#"><i class="fa fa-flag-o"></i> <span> Report Request </span> <span class="menu-arrow"></span></a>
