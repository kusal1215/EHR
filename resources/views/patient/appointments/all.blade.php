    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="{{ route('PatientAppointmentManager.appointments.request') }}"
                    class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Request
                    Appointment</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="mydatadable table table-stripped" id="user_table">
                        ...
                        <tbody>
                            @foreach(Auth::user()->patient_appointments as $appointment)
                            <tr>
                                    ...
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item"
                                                href="{{route('PatientAppointmentManager.appointments.view',$appointment->id)}}">
