...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form method="POST" action="{{route('DoctorReportManager.reports.update', $report->id)}}"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="patient_id" name="patient_id" required>
                                    ...
                                    <option value="{{ $patient->id }}"
                                        {{$patient->id == $report->patient_id ? 'selected':''}}>
                                        {{ $patient->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="age" name="age" class="form-control" type="number" value="{{$report->age}}"
                                    required>
                            </div>
                        </div>
                    </div>
