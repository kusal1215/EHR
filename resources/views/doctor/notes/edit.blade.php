...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form method="POST" action="{{route('DoctorNoteManager.notes.update', $note->id)}}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="patient_id" name="patient_id" required>
                                    ...
                                    <option value="{{ $patient->id }}"
                                        {{$patient->id == $note->patient_id ? 'selected':''}}>
                                        {{ $patient->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="appointment_id" name="appointment_id">
                                    ...
                                    <option value="{{ $appointment->id }}"
                                        {{$appointment->id == $note->appointment_id ? 'selected':''}}>
                                        {{ $appointment->aptId }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="message" name="message" cols="30" rows="4" class="form-control"
                            required>{{$note->message}}</textarea>
                    </div>
