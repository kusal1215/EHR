                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt="John Doe" src="{{asset('/assets/img/user.jpg')}}"
                                                    class="img-fluid">
                                            </span>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="{{ $curr_url=='DoctorManager.doctor'?'active':''}}">
                            <a href="{{route('DoctorManager.doctor')}}"><i class="fa fa-dashboard"></i>
                                <span>Dashboard</span></a>
                        </li>
                        <li class="{{ $curr_url=='DoctorAppointmentManager.appointments'?'active':''}}">
